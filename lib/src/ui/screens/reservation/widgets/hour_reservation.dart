import 'package:fleeve/src/models/Date.dart';
...
class HourReservation extends StatelessWidget {
  final Pickup pickup;
  const HourReservation({required Key? key, required this.pickup})
      : super(key: key);
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Row(
        ...
        children: [
          ...
          ConfirmButton(selectedHours: selectedHours, pickup: pickup, key: key),
        ],
      ),
    );
  }
...
class Body extends StatefulWidget {
  ...
  Body({required Key key, required this.selectedHours, required this.pickup})
      : super(key: key);
...
class _BodyState extends State<Body> {
  ...
  Widget _buildHeaderTitle({required String title, Icon? icon}) {
    return Row(
      children: [
        icon ?? Text(''),
        Text(
